...
public class menuFunction {
    ...
    public static void loadData() {
        ...
        for (String listBook1 : listBook) {
            ...
            listBook3.setTitle(listBook2[1]);
            listBook3.setQua(Integer.parseInt(listBook2[2]));
            listBook3.setPrice(Integer.parseInt(listBook2[3]));
            books.add(listBook3);
        }
    }
    ...
    public static void saveData() {
        ...
        file.writeFile("src\\output.txt", data);
    }
